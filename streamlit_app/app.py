...
st.set_page_config(page_title="Diffusion Image Gen", layout="wide", page_icon="🎨")
...
pg = st.navigation([st.Page("pages/1_📊_Overview.py", title="Overview", icon="📊"),
    st.Page("pages/2_🎨_Generate.py", title="Generate", icon="🎨"),
    st.Page("pages/3_📈_Training.py", title="Training", icon="📈")])
pg.run()
